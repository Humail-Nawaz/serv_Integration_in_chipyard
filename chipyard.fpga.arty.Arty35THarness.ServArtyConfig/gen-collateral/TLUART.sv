...
module TLUART(	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25]
  ...
  input  [7:0]  auto_control_xing_in_a_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  output [7:0]  auto_control_xing_in_d_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25]
    if (reset) begin	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25]
      div <= 16'h115;	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:135:20]
