...
module AXI4Fragmenter_1(	// @[generators/rocket-chip/src/main/scala/amba/axi4/Fragmenter.scala:37:9]
  ...
  wire [30:0] _inc_addr_T_1 = addr + {15'h0, 16'h1 << _deq_q_io_deq_bits_size};	// @[generators/rocket-chip/src/main/scala/amba/axi4/Fragmenter.scala:73:23, :108:{29,38}, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  wire [30:0] _inc_addr_T_3 = addr_1 + {15'h0, 16'h1 << _deq_q_1_io_deq_bits_size};	// @[generators/rocket-chip/src/main/scala/amba/axi4/Fragmenter.scala:73:23, :108:{29,38}, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  wire        _GEN = auto_out_ar_ready & _deq_q_io_deq_valid;	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35, :362:21]
  wire        _GEN_0 = in_aw_ready & _deq_q_1_io_deq_valid;	// @[generators/rocket-chip/src/main/scala/amba/axi4/Fragmenter.scala:168:35, src/main/scala/chisel3/util/Decoupled.scala:51:35, :362:21]
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/amba/axi4/Fragmenter.scala:37:9]
    ...
    if (_GEN_0) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
      r_addr_1 <= _deq_q_1_io_deq_bits_burst == 2'h0 ? _deq_q_1_io_deq_bits_addr : _deq_q_1_io_deq_bits_burst == 2'h2 ? {16'h0, _inc_addr_T_3[14:0] & _wrapMask_T_3[22:8]} | ~{_mux_addr_T_6[30:15], _mux_addr_T_6[14:0] | _wrapMask_T_3[22:8]} : _inc_addr_T_3;	// @[generators/rocket-chip/src/main/scala/amba/axi4/Bundles.scala:33:{21,30}, generators/rocket-chip/src/main/scala/amba/axi4/Fragmenter.scala:37:9, :69:25, :100:34, :108:29, :110:35, :111:{28,59}, :112:{20,33,45,47,49,62}, :114:60, :115:20, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  Queue1_AXI4BundleAR_1 deq_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    ...
    .io_enq_bits_echo_tl_state_size   (auto_in_ar_bits_echo_tl_state_size),
    .io_enq_bits_echo_tl_state_source (auto_in_ar_bits_echo_tl_state_source),
    ...
    .io_deq_bits_echo_tl_state_size   (auto_out_ar_bits_echo_tl_state_size),
    .io_deq_bits_echo_tl_state_source (auto_out_ar_bits_echo_tl_state_source)
  ...
  Queue1_AXI4BundleAW_1 deq_q_1 (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    ...
    .io_enq_bits_echo_tl_state_size   (auto_in_aw_bits_echo_tl_state_size),
    .io_enq_bits_echo_tl_state_source (auto_in_aw_bits_echo_tl_state_source),
    ...
    .io_deq_bits_echo_tl_state_source (auto_out_aw_bits_echo_tl_state_source)
  );	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  assign auto_in_b_bits_echo_tl_state_size = auto_out_b_bits_echo_tl_state_size;	// @[generators/rocket-chip/src/main/scala/amba/axi4/Fragmenter.scala:37:9]
  assign auto_in_b_bits_echo_tl_state_source = auto_out_b_bits_echo_tl_state_source;	// @[generators/rocket-chip/src/main/scala/amba/axi4/Fragmenter.scala:37:9]
  ...
  assign auto_in_r_bits_echo_tl_state_size = auto_out_r_bits_echo_tl_state_size;	// @[generators/rocket-chip/src/main/scala/amba/axi4/Fragmenter.scala:37:9]
  assign auto_in_r_bits_echo_tl_state_source = auto_out_r_bits_echo_tl_state_source;	// @[generators/rocket-chip/src/main/scala/amba/axi4/Fragmenter.scala:37:9]
