...
module AXI4UserYanker(	// @[generators/rocket-chip/src/main/scala/amba/axi4/UserYanker.scala:36:9]
  ...
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/amba/axi4/UserYanker.scala:69:14]
    always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/amba/axi4/UserYanker.scala:69:14]
      if (~reset & ~(~auto_out_r_valid | _Queue2_BundleMap_io_deq_valid)) begin	// @[generators/rocket-chip/src/main/scala/amba/axi4/UserYanker.scala:51:17, :69:{14,15,28}]
      ...
      if (~reset & ~(~auto_out_b_valid | _Queue2_BundleMap_1_io_deq_valid)) begin	// @[generators/rocket-chip/src/main/scala/amba/axi4/UserYanker.scala:51:17, :69:14, :98:{14,15,28}]
  ...
  Queue2_BundleMap Queue2_BundleMap (	// @[generators/rocket-chip/src/main/scala/amba/axi4/UserYanker.scala:51:17]
    ...
    .io_deq_ready          (auto_out_r_valid & auto_in_r_ready & auto_out_r_bits_last),	// @[generators/rocket-chip/src/main/scala/amba/axi4/UserYanker.scala:78:{37,58}]
    .io_deq_valid          (_Queue2_BundleMap_io_deq_valid),
    .io_deq_bits_real_last (auto_in_r_bits_echo_real_last)
  ...
  Queue2_BundleMap Queue2_BundleMap_1 (	// @[generators/rocket-chip/src/main/scala/amba/axi4/UserYanker.scala:51:17]
    ...
    .io_deq_bits_real_last (auto_in_b_bits_echo_real_last)
  );	// @[generators/rocket-chip/src/main/scala/amba/axi4/UserYanker.scala:51:17]
  assign auto_in_aw_ready = auto_out_aw_ready & _Queue2_BundleMap_1_io_enq_ready;	// @[generators/rocket-chip/src/main/scala/amba/axi4/UserYanker.scala:36:9, :51:17, :89:36]
  ...
  assign auto_in_ar_ready = auto_out_ar_ready & _Queue2_BundleMap_io_enq_ready;	// @[generators/rocket-chip/src/main/scala/amba/axi4/UserYanker.scala:36:9, :51:17, :60:36]
  ...
  assign auto_out_aw_valid = auto_in_aw_valid & _Queue2_BundleMap_1_io_enq_ready;	// @[generators/rocket-chip/src/main/scala/amba/axi4/UserYanker.scala:36:9, :51:17, :90:36]
  ...
  assign auto_out_ar_valid = auto_in_ar_valid & _Queue2_BundleMap_io_enq_ready;	// @[generators/rocket-chip/src/main/scala/amba/axi4/UserYanker.scala:36:9, :51:17, :61:36]
