...
module SBToTL(	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
  ...
  wire [101:0]    _GEN_5 = {io_addrIn[127:31], io_addrIn[30:26] ^ 5'h15};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46}]
  wire            _pfbits_legal_T_54 = io_sizeIn < 3'h3;	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:92:38]
  wire [99:0]     _GEN_6 = {io_addrIn[127:31], io_addrIn[30:28] ^ 3'h6};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46}]
  wire            io_rdLegal_0 = ~(|(io_addrIn[127:13])) | ~(|_GEN_0) | {io_addrIn[127:17], ~(io_addrIn[16])} == 112'h0 | ~(|_GEN_1) | ~(|_GEN_2) | ~(|_GEN_3) | ~(|_GEN_4) | ~(|_GEN_5) | _pfbits_legal_T_54 & ~(|_GEN_6);	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:274:16, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:92:38, :137:{31,41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:684:54, :685:42, :686:26]
  wire            io_wrLegal_0 = ~(|(io_addrIn[127:13])) | ~(|_GEN_0) | ~(|_GEN_1) | ~(|_GEN_2) | ~(|_GEN_3) | ~(|_GEN_4) | ~(|_GEN_5) | _pfbits_legal_T_54 & ~(|_GEN_6);	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:274:16, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:92:38, :137:{41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:684:54, :685:42, :686:26]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
      ...
      if (_GEN_7) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:349:19]
        if (io_rdEn & io_rdLegal_0)	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:350:30, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42, :686:26]
          sbState <= 3'h1;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:295:26]
        else if (io_wrEn & io_wrLegal_0)	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:351:30, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42, :686:26]
  ...
  Queue2_TLBundleD_a31d8s1k1z4u d_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_out_a_bits_address = io_addrIn[30:0];	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:31]
  ...
  assign io_rdLegal = io_rdLegal_0;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42, :686:26]
  assign io_wrLegal = io_wrLegal_0;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42, :686:26]
