...
module Queue2_AXI4BundleR(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  ram_2x36 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_last, io_enq_bits_resp, io_enq_bits_data, 1'h0})	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  ...
  assign io_deq_bits_id = _ram_ext_R0_data[0];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_data = _ram_ext_R0_data[32:1];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_resp = _ram_ext_R0_data[34:33];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
