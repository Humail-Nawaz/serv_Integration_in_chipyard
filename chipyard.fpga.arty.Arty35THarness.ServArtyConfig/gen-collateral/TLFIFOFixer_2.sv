...
module TLFIFOFixer_2(	// @[generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:50:9]
  ...
  wire        _a_id_T_4 = {auto_anon_in_a_bits_address[28:27], auto_anon_in_a_bits_address[25], auto_anon_in_a_bits_address[20], auto_anon_in_a_bits_address[16], auto_anon_in_a_bits_address[13:12]} == 7'h0;	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{41,46,59}]
  wire [1:0]  _GEN = {2{_a_id_T_4}} | {2{{auto_anon_in_a_bits_address[28:27], auto_anon_in_a_bits_address[25], auto_anon_in_a_bits_address[20], auto_anon_in_a_bits_address[16], auto_anon_in_a_bits_address[13], ~(auto_anon_in_a_bits_address[12])} == 7'h0 | {auto_anon_in_a_bits_address[28:27] ^ 2'h2, auto_anon_in_a_bits_address[25], auto_anon_in_a_bits_address[20], auto_anon_in_a_bits_address[16], auto_anon_in_a_bits_address[13:12]} == 7'h0}};	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:629:89, src/main/scala/chisel3/util/Mux.scala:30:73]
  wire [2:0]  a_id = {_a_id_T_4 | {auto_anon_in_a_bits_address[28:27], auto_anon_in_a_bits_address[25], ~(auto_anon_in_a_bits_address[20]), auto_anon_in_a_bits_address[13:12]} == 6'h0, _GEN[1] | {auto_anon_in_a_bits_address[28:27], auto_anon_in_a_bits_address[25], auto_anon_in_a_bits_address[20], ~(auto_anon_in_a_bits_address[16])} == 5'h0, _GEN[0] | {auto_anon_in_a_bits_address[28:27], auto_anon_in_a_bits_address[25], auto_anon_in_a_bits_address[20], auto_anon_in_a_bits_address[16], ~(auto_anon_in_a_bits_address[13:12])} == 7'h0} | ({auto_anon_in_a_bits_address[28:27], ~(auto_anon_in_a_bits_address[25]), auto_anon_in_a_bits_address[20], auto_anon_in_a_bits_address[16]} == 5'h0 ? 3'h5 : 3'h0) | ({auto_anon_in_a_bits_address[28], ~(auto_anon_in_a_bits_address[27])} == 2'h0 ? 3'h6 : 3'h0);	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46,59}, src/main/scala/chisel3/util/Mux.scala:30:73]
  ...
  wire        _GEN_1 = a_first & _stalls_id_T;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:231:25, generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:80:21, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:50:9]
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:50:9]
      ...
      flight_0 <= ~(_GEN_0 & auto_anon_out_d_bits_source == 4'h0) & (_GEN_1 & auto_anon_in_a_bits_source == 4'h0 | flight_0);	// @[generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:75:42, :79:27, :80:{21,35,62}, :81:{21,35,62}, src/main/scala/chisel3/util/Decoupled.scala:51:35]
      flight_1 <= ~(_GEN_0 & auto_anon_out_d_bits_source == 4'h1) & (_GEN_1 & auto_anon_in_a_bits_source == 4'h1 | flight_1);	// @[generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:75:42, :79:27, :80:{21,35,62}, :81:{21,35,62}, src/main/scala/chisel3/util/Decoupled.scala:51:35]
      flight_2 <= ~(_GEN_0 & auto_anon_out_d_bits_source == 4'h2) & (_GEN_1 & auto_anon_in_a_bits_source == 4'h2 | flight_2);	// @[generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:75:42, :79:27, :80:{21,35,62}, :81:{21,35,62}, src/main/scala/chisel3/util/Decoupled.scala:51:35]
      flight_3 <= ~(_GEN_0 & auto_anon_out_d_bits_source == 4'h3) & (_GEN_1 & auto_anon_in_a_bits_source == 4'h3 | flight_3);	// @[generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:75:42, :79:27, :80:{21,35,62}, :81:{21,35,62}, src/main/scala/chisel3/util/Decoupled.scala:51:35]
    end
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:50:9]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:50:9]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:50:9]
        ...
        a_first_counter = _RANDOM[/*Zero width*/ 1'b0][8:0];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:50:9]
        d_first_counter = _RANDOM[/*Zero width*/ 1'b0][17:9];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:50:9]
        flight_0 = _RANDOM[/*Zero width*/ 1'b0][18];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:50:9, :79:27]
        flight_1 = _RANDOM[/*Zero width*/ 1'b0][19];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:50:9, :79:27]
        flight_2 = _RANDOM[/*Zero width*/ 1'b0][20];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:50:9, :79:27]
        flight_3 = _RANDOM[/*Zero width*/ 1'b0][21];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:50:9, :79:27]
        stalls_id = _RANDOM[/*Zero width*/ 1'b0][29:27];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:50:9, :85:30]
      `endif // RANDOMIZE_REG_INIT
    end // initial
